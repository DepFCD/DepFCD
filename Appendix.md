...
| dependency facade          | The dependency facade which downstream coupling with upstream | $G_F = \langleV', D'\rangle \\ D' = \lbrace{d = e_i \to e_j, \\e_i.ownership == 'extensive'\  \land \ e_j.ownership.endwith('native') \cup \\e_j.ownership == 'extensive'\ \land \ e_i.ownership.endwith('native')}\\\rbrace$ |
