...
set CLASSPATH=%APP_HOME%\lib\RefactoringMiner-2.2.0.jar;%APP_HOME%\lib\org.eclipse.jgit-5.13.0.202109080827-r.jar;%APP_HOME%\lib\slf4j-log4j12-1.7.32.jar;%APP_HOME%\lib\junit-4.11.jar;%APP_HOME%\lib\org.eclipse.jdt.core-3.27.0.jar;%APP_HOME%\lib\commons-text-1.9.jar;%APP_HOME%\lib\github-api-1.135.jar;%APP_HOME%\lib\java-diff-utils-4.11.jar;%APP_HOME%\lib\JavaEWAH-1.1.12.jar;%APP_HOME%\lib\slf4j-api-1.7.32.jar;%APP_HOME%\lib\log4j-1.2.17.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar;%APP_HOME%\lib\org.eclipse.core.resources-3.15.100.jar;%APP_HOME%\lib\org.eclipse.text-3.12.0.jar;%APP_HOME%\lib\org.eclipse.core.expressions-3.8.0.jar;%APP_HOME%\lib\org.eclipse.core.runtime-3.23.0.jar;%APP_HOME%\lib\org.eclipse.core.filesystem-1.9.100.jar;%APP_HOME%\lib\commons-lang3-3.11.jar;%APP_HOME%\lib\jackson-annotations-2.13.0.jar;%APP_HOME%\lib\jackson-core-2.13.0.jar;%APP_HOME%\lib\jackson-databind-2.13.0.jar;%APP_HOME%\lib\commons-io-2.8.0.jar;%APP_HOME%\lib\org.eclipse.osgi-3.17.0.jar;%APP_HOME%\lib\org.eclipse.core.jobs-3.12.0.jar;%APP_HOME%\lib\org.eclipse.core.contenttype-3.8.0.jar;%APP_HOME%\lib\org.eclipse.equinox.app-1.6.0.jar;%APP_HOME%\lib\org.eclipse.equinox.registry-3.11.0.jar;%APP_HOME%\lib\org.eclipse.equinox.preferences-3.9.0.jar;%APP_HOME%\lib\org.eclipse.core.commands-3.10.100.jar;%APP_HOME%\lib\org.eclipse.equinox.common-3.15.0.jar
